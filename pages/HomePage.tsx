    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="relative min-h-screen bg-gradient-to-br from-blue-900 via-black to-gray-900 overflow-hidden">
                ...
                {/* Hero Content */}
                <div className="relative z-10 flex flex-col items-start justify-center min-h-screen text-white px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pt-8 sm:pt-10 lg:pt-12 pb-20 sm:pb-24 lg:pb-32">
