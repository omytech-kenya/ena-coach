    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="relative min-h-screen bg-gradient-to-br from-blue-900 via-black to-gray-900 overflow-hidden">
                ...
                {/* Hero Content */}
                <div className="relative z-10 flex flex-col items-start justify-start min-h-screen text-white px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pt-2 sm:pt-8 lg:pt-16 pb-16 sm:pb-20 lg:pb-28">
